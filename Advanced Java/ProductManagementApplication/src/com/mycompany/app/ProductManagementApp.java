	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		while (true) {
			...
			case "B":
				...
				pb1.setProduct_ID(sc.next());
				System.out.println("-----------------------------");

				System.out.println("Enter the Product Name");
				System.out.println("-----------------------------");

				pb1.setProduct_Name(sc.next());
				System.out.println("-----------------------------");
			...
			case "C":
				...
				pb2.setProduct_ID(sc.next());
				System.out.println("-----------------------------");

				System.out.println("Enter New Product Name");
				System.out.println("-----------------------------");

				pb2.setProduct_Name(sc.next());
				System.out.println("-----------------------------");
